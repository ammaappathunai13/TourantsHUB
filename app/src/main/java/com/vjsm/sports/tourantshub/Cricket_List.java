...
public class Cricket_List extends Fragment implements ListCustomAdapter.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {
...
String UserId;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_cricket__list, container, false);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(Cricket_List.this);
    ...
    private void getdata() {
        ...
        final CollectionReference clf = fb.collection("TCRICKET");
    ...
    private void display(final String delete, String ref) {
        if (ref.equals("delete")) {
            ...
            builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    fb=FirebaseFirestore.getInstance();
                    fb.collection("TCRICKET").document(delete).delete();
                    onRefresh();
