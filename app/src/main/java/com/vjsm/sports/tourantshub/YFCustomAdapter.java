...
public class YFCustomAdapter extends RecyclerView.Adapter<YFCustomAdapter.MyViewHolder> {
        ArrayList<YUsers> personNames = new ArrayList<>();
private Yfshow mListener;
        Context context;
    ...
    public void setOnItemClickListener(Yfshow listener) {
        mListener =  listener;
    }

    public YFCustomAdapter(ArrayList<YUsers> personNames, Context context) {
    ...
    @Override
    public YFCustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.yrow, parent, false);
        YFCustomAdapter.MyViewHolder vh = new YFCustomAdapter.MyViewHolder(v); // pass the view to View Holder
    ...
    @Override
    public void onBindViewHolder(final YFCustomAdapter.MyViewHolder holder, final int position) {
