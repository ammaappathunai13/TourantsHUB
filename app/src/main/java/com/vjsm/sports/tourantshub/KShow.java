...
public class KShow extends AppCompatActivity implements CustomAdapter.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kshow);

        searchView=(EditText)findViewById(R.id.loading);
        districtsearch=(Spinner)findViewById(R.id.search);
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(KShow.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.search_list));
        ...
        customAdapter.setOnItemClickListener(KShow.this);
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int mDay = mcurrentDate.get(Calendar.DAY_OF_MONTH);
                DatePickerDialog mDatePicker = new DatePickerDialog(KShow.this, new DatePickerDialog.OnDateSetListener() {
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        searchView.setText(selectedday + "/" + (selectedmonth + 1) + "/" + selectedyear);
    ...
    private void getData() {
        ...
        fb.collection("TKABADDI").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        Intent intent=new Intent(KShow.this,Details.class);
