...
public class Yvshow extends AppCompatActivity  implements CustomAdapter.OnItemClickListener{
...
ProgressDialog progressDialog;
    ...
    private YVCustomAdapter customAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yvshow);
        ...
        fb.collection("VolleyballVideosTHUB").orderBy("no",Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        Intent s=new Intent(Yvshow.this,YoutubeApi.class);
