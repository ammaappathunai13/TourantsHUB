            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    auth.put("PhoneNumber",empty);
                    {
                        ...
                        fb.collection("TourantsHubAuth").document(useid).set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                ...
                                Intent i=new Intent(CodeVerification.this,HomePage_Loader_TourantsHub.class);
