...
public class VShow extends AppCompatActivity implements CustomAdapter.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(VShow.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.search_list));
        ...
        customAdapter.setOnItemClickListener(VShow.this);
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int mDay = mcurrentDate.get(Calendar.DAY_OF_MONTH);
                DatePickerDialog mDatePicker = new DatePickerDialog(VShow.this, new DatePickerDialog.OnDateSetListener() {
    ...
    private void getData() {
        ...
        fb.collection("TVOLLEYBALL").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        Intent intent=new Intent(VShow.this,Details.class);
