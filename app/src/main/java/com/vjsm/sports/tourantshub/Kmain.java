...
public class Kmain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeIcons.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ss=new Intent(Kmain.this,HomePage_Loader_TourantsHub.class);
                startActivity(ss);
                ActivityCompat.finishAffinity(Kmain.this);            }
        });
        ...
        VideoIcons.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vs=new Intent(Kmain.this,Ykshow.class);
                startActivity(vs);
            }
        });
        VideoText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sm=new Intent(Kmain.this,Ykshow.class);
                startActivity(sm);
            }
        });
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        editor.clear().commit();
                        Intent s=new Intent(Kmain.this,LoginPage.class);
                        startActivity(s);
        ...
        up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent2=new Intent(Kmain.this, KUpload.class);
        ...
        vie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent2=new Intent(Kmain.this, KShow.class);
                intent2.putExtra("send",gets);
                startActivity(intent2);
            }
        });
