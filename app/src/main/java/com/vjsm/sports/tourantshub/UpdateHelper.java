...
public class UpdateHelper {
    public  static String Key_Enable="is_Update_Tourantshub";
    public  static String Key_Version="version_Tourantshub";

    public  static String Key_url_="update_url_Tourantshub";
