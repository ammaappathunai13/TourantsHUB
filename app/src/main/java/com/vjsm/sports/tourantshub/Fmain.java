    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeIcons.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ss=new Intent(Fmain.this,HomePage_Loader_TourantsHub.class);
                startActivity(ss);
                ActivityCompat.finishAffinity(Fmain.this);
            }
        });
        ...
        VideoIcons.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vs=new Intent(Fmain.this,Yfshow.class);
                startActivity(vs);
            }
        });
        VideoText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sm=new Intent(Fmain.this,Yfshow.class);
                startActivity(sm);
            }
        });
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        editor.clear().commit();
                        Intent s=new Intent(Fmain.this,LoginPage.class);
                        startActivity(s);
        ...
        up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent2=new Intent(Fmain.this, FUpload.class);
        ...
        vie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent2=new Intent(Fmain.this, FShow.class);
                intent2.putExtra("send",gets);
                startActivity(intent2);
            }
        });
