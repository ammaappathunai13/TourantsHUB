...
public class YKCustomAdapter extends RecyclerView.Adapter<YKCustomAdapter.MyViewHolder> {
        ArrayList<YUsers> personNames = new ArrayList<>();
private Ykshow mListener;
        Context context;
    ...
    public void setOnItemClickListener(Ykshow listener) {
        mListener =  listener;
    }

    public YKCustomAdapter(ArrayList<YUsers> personNames, Context context) {
    ...
    @Override
    public YKCustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.yrow, parent, false);
        YKCustomAdapter.MyViewHolder vh = new YKCustomAdapter.MyViewHolder(v); // pass the view to View Holder
    ...
    @Override
    public void onBindViewHolder(final YKCustomAdapter.MyViewHolder holder, final int position) {
