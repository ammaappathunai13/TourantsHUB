...
public class Yfshow extends AppCompatActivity implements YFCustomAdapter.OnItemClickListener {
    ...
    private YFCustomAdapter customAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yfshow);
        ...
        fb.collection("FootballVideosTHUB").orderBy("no",Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        Intent s=new Intent(Yfshow.this,YoutubeApi.class);
