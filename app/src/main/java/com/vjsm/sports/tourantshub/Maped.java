...
String cp,fp,kp,vp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cp=intent.getStringExtra("Checker");
        names = intent.getStringExtra(CUpload.Name);
        place = intent.getStringExtra(CUpload.Place);
        district = intent.getStringExtra(CUpload.District);
        startdate = intent.getStringExtra(CUpload.StDate);
        mantdate = intent.getStringExtra(CUpload.ManDate);
        madtdate = intent.getStringExtra(CUpload.MadDate);
        phone = intent.getStringExtra(CUpload.PhoneNumber);
    ...
    private void cSend(double longitude, double latitude) {
        ...
        if(cp.equals("cupload")){
            Intent intent=new Intent(Maped.this,CUpload.class);
        ...
        if (cp.equals("fupload")){
            Intent intent=new Intent(Maped.this,FUpload.class);
            intent.putExtra(SName,names);
            intent.putExtra(SPlace,place);
            intent.putExtra(SSTDate,startdate);
            intent.putExtra(SDistrict,district);
        ...
        if ((cp.equals("kupload"))){
            Intent intent=new Intent(Maped.this,KUpload.class);
            intent.putExtra(SName,names);
            intent.putExtra(SPlace,place);
            intent.putExtra(SSTDate,startdate);
            intent.putExtra(SDistrict,district);
        ...
        if (cp.equals("vupload")){
            Intent intent=new Intent(Maped.this,VUpload.class);
            intent.putExtra(SName,names);
            intent.putExtra(SPlace,place);
            intent.putExtra(SSTDate,startdate);
            intent.putExtra(SDistrict,district);
