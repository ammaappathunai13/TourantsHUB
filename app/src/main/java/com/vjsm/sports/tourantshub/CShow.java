...
public class CShow extends AppCompatActivity implements CustomAdapter.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(CShow.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.search_list));
        ...
        customAdapter.setOnItemClickListener(CShow.this);
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int mDay = mcurrentDate.get(Calendar.DAY_OF_MONTH);
                DatePickerDialog mDatePicker = new DatePickerDialog(CShow.this, new DatePickerDialog.OnDateSetListener() {
...
getdata();
    ...
    private void getdata() {
        ...
        fb.collection("TCRICKET").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        Intent intent=new Intent(CShow.this,Details.class);
