...
builder=new AlertDialog.Builder(this);
        ...
        HomeIcons.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               Intent ss=new Intent(Cmain.this,HomePage_Loader_TourantsHub.class);
               startActivity(ss);
                ActivityCompat.finishAffinity(Cmain.this);            }
        });
        ...
        VideoIcons.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vs=new Intent(Cmain.this,Ycshow.class);
                startActivity(vs);
            }
        });
        VideoText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sm=new Intent(Cmain.this,Ycshow.class);
                startActivity(sm);
            }
        });
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        editor.clear().commit();
                        Intent s=new Intent(Cmain.this,LoginPage.class);
                        startActivity(s);
        ...
        up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent2=new Intent(Cmain.this, CUpload.class);
        ...
        vie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent2=new Intent(Cmain.this, CShow.class);
                intent2.putExtra("send",gets);
                startActivity(intent2);
            }
        });
