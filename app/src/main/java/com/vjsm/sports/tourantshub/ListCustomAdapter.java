...
public class ListCustomAdapter extends RecyclerView.Adapter<ListCustomAdapter.MyViewHolder> {
    ...
    public void setOnItemClickListener(ListCustomAdapter.OnItemClickListener listener) {
        mListener =  listener;
    }

    public ListCustomAdapter(ArrayList<Users> personNames, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ListCustomAdapter.MyViewHolder vh = new ListCustomAdapter.MyViewHolder(v); // pass the view to View Holder
        return vh;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.Title.setText(personNames.get(position).getTitle());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView name, place, district, sdate, madtdate, mantdate, phone,Title;
        ImageView imagev;
