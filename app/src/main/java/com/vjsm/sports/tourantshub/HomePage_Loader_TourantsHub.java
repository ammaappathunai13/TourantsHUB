...
public class HomePage_Loader_TourantsHub extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_page__loader__tourants_hub);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        setTitle("TourantsHUB");
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(HomePage_Loader_TourantsHub.this);
