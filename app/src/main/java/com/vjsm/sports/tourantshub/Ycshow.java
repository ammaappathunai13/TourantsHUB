...
public class Ycshow extends AppCompatActivity implements CustomAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ycshow);
        ...
        customAdapter.setOnItemClickListener(Ycshow.this);
      ...
      fb.collection("CricketVideosTHUB").orderBy("no",Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
          @Override
...
if(task.isSuccessful()){
    ...
    public void onItemClick(int position) {
        Intent s=new Intent(Ycshow.this,YoutubeApi.class);
