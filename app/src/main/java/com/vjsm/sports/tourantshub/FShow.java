...
public class FShow extends AppCompatActivity implements CustomAdapter.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(FShow.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.search_list));
        ...
        customAdapter.setOnItemClickListener(FShow.this);
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int mDay = mcurrentDate.get(Calendar.DAY_OF_MONTH);
                DatePickerDialog mDatePicker = new DatePickerDialog(FShow.this, new DatePickerDialog.OnDateSetListener() {
    ...
    private void getData() {
        ...
        fb.collection("TFOOTBALL").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        Intent intent=new Intent(FShow.this,Details.class);
